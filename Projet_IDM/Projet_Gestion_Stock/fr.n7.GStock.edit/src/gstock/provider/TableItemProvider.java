...
/**
 * This is the item provider adapter for a {@link gstock.Table} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TableItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GstockPackage.Literals.TABLE__COLONNES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Table.class)) {
			case GstockPackage.TABLE__ID:
			case GstockPackage.TABLE__NOM:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case GstockPackage.TABLE__COLONNES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GstockPackage.Literals.TABLE__COLONNES,
				 GstockFactory.eINSTANCE.createColonne_derivee()));

		newChildDescriptors.add
			(createChildParameter
				(GstockPackage.Literals.TABLE__COLONNES,
				 GstockFactory.eINSTANCE.createColonne_referencee()));

		newChildDescriptors.add
			(createChildParameter
				(GstockPackage.Literals.TABLE__COLONNES,
				 GstockFactory.eINSTANCE.createColonnesimple()));
	}

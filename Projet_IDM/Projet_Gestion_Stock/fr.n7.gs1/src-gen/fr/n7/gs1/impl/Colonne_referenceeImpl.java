 ...
 * </p>
 * <ul>
 *   <li>{@link fr.n7.gs1.impl.Colonne_referenceeImpl#getTable <em>Table</em>}</li>
 *   <li>{@link fr.n7.gs1.impl.Colonne_referenceeImpl#getColonne <em>Colonne</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Colonne_referenceeImpl extends ColonneImpl implements Colonne_referencee
{
  ...
  {
    return Gs1Package.Literals.COLONNE_REFERENCEE;
  }
    ...
    if (table != null && table.eIsProxy())
    {
      ...
      if (table != oldTable)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, Gs1Package.COLONNE_REFERENCEE__TABLE, oldTable, table));
      }
    }
    return table;
  }
  ...
  public void setTable(Table newTable)
  {
    ...
    table = newTable;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Gs1Package.COLONNE_REFERENCEE__TABLE, oldTable, table));
  }
  ...
  public Colonne getColonne()
  {
    if (colonne != null && colonne.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, Gs1Package.COLONNE_REFERENCEE__COLONNE, oldColonne, colonne));
      }
    }
    return colonne;
  }
  ...
  public void setColonne(Colonne newColonne)
  {
    ...
    colonne = newColonne;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Gs1Package.COLONNE_REFERENCEE__COLONNE, oldColonne, colonne));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case Gs1Package.COLONNE_REFERENCEE__TABLE:
        if (resolve) return getTable();
        return basicGetTable();
      case Gs1Package.COLONNE_REFERENCEE__COLONNE:
